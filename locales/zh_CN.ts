...
<context>
    ...
    <message>
        ...
        <translation>成功推送：&lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>创意工坊文件夹：{existing_instance_workshop_folder}&lt;br&gt;&lt;br&gt;选项 1：转换为 SteamCMD&lt;br&gt;RimSort 会将所有创意工坊模组复制到新实例的本地模组文件夹，将它们转换为您可以在新实例中管理的 SteamCMD 模组。此实例的创意工坊文件夹将被忽略，以防止重复模组。&lt;br&gt;&lt;br&gt;选项 2：保留创意工坊文件夹&lt;br&gt;新实例将使用与原始实例相同的创意工坊文件夹。如果需要，您可以稍后在设置中更改此设置。&lt;br&gt;&lt;br&gt;您想如何继续？</translation>
    </message>
    <message>
