...
PublishedFileIDs are needed to retrieve mods from Steam!</source>
        <translation>這通常是由於 Steam WebAPI 金鑰無效/遺失，或 Steam WebAPI 的連線問題造成的。
從 Steam 檢索模組需要 PublishedFileID！</translation>
    </message>
    <message>
...
A report of discrepancies is generated. You will be prompted for these paths in order:
	...
	2) Select input B</source>
        <translation>- 這將產生 2 個 Steam DB 之間依賴資料的準確比較。
產生差異報告。系統會依序提示您輸入這些路徑：
...
The resultant database, C, is saved to a user-specified path. You will be prompted for these paths in order:
	...
	3) Select output C (resultant db)</source>
        <translation>- 這將有效地以 B 的鍵/值遞歸地覆寫結果資料庫中的 A 的鍵/值。
- 異常不會被遞歸更新。相反，它們將被 B 的密鑰完全覆蓋。
- 以下情況除外：

	{DB_BUILDER_RECURSE_EXCEPTIONS}

產生的資料庫 C 將儲存到使用者指定的路徑。系統會依序提示您輸入這些路徑：
...
{url}</source>
        <translation>已將活躍模組清單報告上傳至 Rentry.co！ URL 已複製到您的剪貼簿：
...
The updated versions won't appear until you refresh. Refresh now?</source>
        <translation>{count} 個模組已自動更新。



刷新後才會顯示更新的版本。現在刷新？ {summary}</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>RimSort 無法偵測到 Steam 用戶端，或者可能沒有回應。請確保 Steam 已安裝並正在運作。如果您是 Steam 用戶，請檢查 Steam 是否正在運行並且您是否已登入。嘗試重新啟動 Steam。</translation>
    </message>
    <message>
