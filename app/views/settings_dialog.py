...
class SettingsDialog(QDialog):
    ...
    def _do_sorting_tab(self) -> None:
        ...
        # New: Use About.xml dependencies for sorting
        self.use_about_dependencies_checkbox = QCheckBox(
            self.tr("Use dependencies in mods About files for sorting")
        )
        sort_group_box_layout.addWidget(self.use_about_dependencies_checkbox)
