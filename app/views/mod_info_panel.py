...
class ModInfo:
    ...
    def __init__(self, settings_controller: SettingsController) -> None:
        ...
        # Add Steam URL widgets under path
        self.mod_info_path.addWidget(self.mod_info_steam_url_label, 20)
        self.mod_info_path.addWidget(self.mod_info_steam_url_value, 80)
