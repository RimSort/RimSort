...
def xml_path_to_json(path: str) -> Dict[str, Any]:
    ...
    Attempts to parse the XML file using xmltodict and, if it fails, tries using BeautifulSoup as a fallback.

    :param path: Path to the XML file.
    :return: JSON representation of the XML file.
    """
        ...
        try:
            ...
            with open(path, "rb") as f:
                ...
                for empty_tag in empty_tags:
                    empty_tag.extract()
                # Parse the modified XML with xmltodict
