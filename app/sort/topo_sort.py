...
def find_circular_dependencies(dependency_graph: dict[str, set[str]]) -> None:
    ...
    show_warning(
        ...
        information=QCoreApplication.translate("find_circular_dependencies","RimSort found circular dependencies in your mods list. Please see the details for dependency loops."),
        details="\n\n".join(cycle_strings),
    )
