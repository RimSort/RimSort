...
# This script only copies/moves update files from source folder to destination folder
# and relaunches RimSort. All user prompts and backups are handled by Python code.
# ========================================================================
